...
gui.CaDD = uicontrol('style','popupmenu',fillinL{:},'position',[.05 .195 .6 .08],'string',' ','visible','off','callback',@changeCaMouse);
gui.CaT = uicontrol('style','edit',fillinC{:},'position',[.735 .285 .225 .08],'string','');

uicontrol('style','pushbutton',fillinC{:},'position',[.3 .04 .4 .14],'string','Save timestamps','callback',@SaveTimeFile);
guidata(gui.h,gui);